...
let mainPageWindow = document.querySelector('.main_inf');
let innerAboutTextBlock = document.querySelector('.close_about_inf_block');
...
let getMainAboutBlock = document.querySelector('.modal_about_block');
let openMagicCircle = document.querySelector('.modal_about_block');
let closeMagicCircle = document.querySelector('.close_about_page');
let aboutContentText = document.querySelector('.about_content');
for (let i = 0; i < getInnerModalPoints.length; i++) {

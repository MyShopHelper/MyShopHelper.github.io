...
// productInputToSearch.addEventListener('keyup', FilterFunction)

// function FilterFunction(){
//     let filterValue = productInputToSearch.value;
//     console.log(filterValue.toUpperCase());
// }

// let ProductGrid = (document.querySelector('.content') as HTMLInputElement).childNodes[1].childNodes[1].childNodes;
